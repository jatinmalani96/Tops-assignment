...
// Q5. Write command to show all data from product collections and sort in ascending order.
    ...
    // db.collection("Product").insertOne({name:"T-shirts",price:500,qty:7}).then(result =>{
    //     console.log("successfull add product...");
    // }).catch(err=>{
    //     console.log(err);
    // })

    // const d1 = {name:"watch",price:2000,qty:2}
    // const d2 = {name:"mobile",price:15000,qty:1}
    // const d3 = {name:"tv",price:15000,qty:10}
    // const d4 = {name:"speaker",price:2500,qty:5}

    // db.collection("Product").insertMany([d1,d2,d3,d4]).then(result=>{
    //     console.log("successfull add product...");
    // }).catch(err=>{
    //     console.log(err);
    // })
